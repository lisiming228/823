...
//        $b=$type=="background"?mt_rand(20,125):mt_rand(126,255);
    ...
    private function setText(){
        ...
        for ($i=0;$i<$this->codeLen;$i++) {
            ...
            $box=imagettfbbox($size,$angle,"D:/PHPSTUDY/PHPTutorial/WWW/8.8/mvc2/application/static/font/demo.ttc",$str[$i]);
            imagettftext($this->image, $size, $angle, mt_rand(max($space*($i*2-1),0)+5,$space*($i*2+1)-5), ($box[0]-$box[7])+mt_rand(0,$this->height-($box[0]-$box[7])), $this->setColor("a"), "D:/PHPSTUDY/PHPTutorial/WWW/8.8/mvc2/application/static/font/demo.ttc", $str[$i]);
        }
    }
